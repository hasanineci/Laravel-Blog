        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{ url('admin')}}" class="d-block">Hasan İNECİ</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item @yield('menu-panel')">
                            <a href="#" class="nav-link @yield('menu-panel-active')">
                        ...
                        <li class="nav-item @yield('menu-widget')">
                            <a href="pages/widgets.html" class="nav-link @yield('menu-widget')">

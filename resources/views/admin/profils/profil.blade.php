                        ...
                        <div class="tab-content">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="inputJob" placeholder="Meslek">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputSkills" placeholder="Eğitim">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row pt-5">
                                    <div class="offset-sm-2 col-sm-10">
                                        <button type="submit" class="btn btn-success p-2"
                                            style="width: 150px;">KAYDET</button>
                                    </div>
                                </div>
                            </form>
                        </div> <!-- /.tab-content -->
